...
from ANUSHKA.utils import get_size, is_subscribed, get_poster, search_gagala, temp, get_settings, save_group_settings, get_shortlink, get_tutorial, send_all, check_verification, get_token
...
async def filter_languages_cb_handler(client: Client, query: CallbackQuery):
    ...
    btn.insert(0, [
        InlineKeyboardButton(f'⛔ CHANNEL ⛔️', url='https://telegram.dog/ANUSHKA_SEN_CHANNEL')
    ])
    offset = 0
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        await query.message.edit_text(
            text=script.START_TXT.format(query.from_user.mention, temp.B_MEN, temp.U_NAME, temp.B_NAME),
            reply_markup=reply_markup,
            parse_mode=enums.ParseMode.HTML
        )
        ...
        buttons = [[
            ...
            InlineKeyboardButton('ꜱᴜᴘᴘᴏʀᴛ', url="https://telegram.me/ANUSHKA_SEN_CHANNEL"),
        ...
        buttons = [[
           InlineKeyboardButton('ᴏᴡɴᴇʀ', url='https://telegram.dog/ANUSHKA_SEN_CHANNEL'),
           InlineKeyboardButton('ꜱᴜᴘᴘᴏʀᴛ', url='https://telegram.dog/ANUSHKA_SEN_CHANNEL')
        ], [
            InlineKeyboardButton('ʙᴀᴄᴋ', callback_data='start')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        ...
        buttons = [[
           InlineKeyboardButton('ʀᴇᴘᴏ', url='https://github.com/anushka-sen-bot/ANUSHKA-SEN'),
           InlineKeyboardButton('ᴏᴡɴᴇʀ', url='https://telegram.dog/ANUSHKA_SEN_CHANNEL')
        ], [
            InlineKeyboardButton('ʙᴀᴄᴋ', callback_data='help2')
        ]]
